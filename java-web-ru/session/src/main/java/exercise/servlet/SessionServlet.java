...
public class SessionServlet extends HttpServlet {
    ...
    private void login(HttpServletRequest request,
        ...
        Map<String, String> currentUser = users.findByEmail(email);

        if (currentUser == null || !currentUser.get("password").equals(password)) {
            ...
            session.setAttribute("userId", currentUser.get("id") );
